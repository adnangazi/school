...
bool MonoEsercizio::operator==(const Esercizio & e) const {
    ...
    //MET == static_cast<const MonoEsercizio*>(&e)->MET è un controllo sicuro nonostante lo static_cast, per via del controllo del tipo dinamico fatto in Esercizio::operator==(e)
}
