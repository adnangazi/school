...
void accompattaSx(int * b, int inizio, int & lung) {
    for (int i = inizio; i < lung; ++i) { //accompatto verso sinistra
        b[i] = b[i + 1];
    }
    lung--;
}
...
int main() {
    int X[400], P[20], n_ele, nP, lim1, lim2, lim3, hf, lung = 0, z = 0; //lunghezza della H-Fetta hf, numero di elementi consumati nel pattern
